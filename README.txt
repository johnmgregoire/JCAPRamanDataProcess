John M Gregoire 11 May 2016, 

All code written by John Gregoire and Santosh Suram. Code is a work in progress for analyzing and visualizing JCAP-HTE data.

The top level program is DataParseApp.py
